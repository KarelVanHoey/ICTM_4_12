...
class RRT_Drive:
    ...
    def get_angle(self, direction_facing, aruco_friend):
        ...
        print('arctan2', np.arctan2((self.Y[1] - aruco_friend[1]), (self.X[1] - aruco_friend[0])))
        angle_0 = condition_angle(angle_0)
        comm = [angle_0]
        print("heading", direction_facing[0])
        print("arctan resultaat",  np.arctan2((self.Y[1] - aruco_friend[1]), (self.X[1] - aruco_friend[0])) * (180/np.pi))
        print("th",th)
